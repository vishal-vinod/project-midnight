...
import time
import cv2
from data_ops import SonyDataset, SonyTestDataset, PixelTrainSet
import torch
...
def train(args, no_of_items, load=False):
    ...
    target_trainset = PixelTrainSet(args.target_input_dir, args.target_gt_dir, args.ps, no_of_items=args.num_target_samples)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--target_input_dir', type=str, default='/workspace/midnight/dataset/Pixel/short/')
    parser.add_argument('--target_gt_dir', type=str, default='/workspace/midnight/dataset/Pixel/long/')
    ...
    parser.add_argument('--model_load_dir2', type=str, default='/workspace/midnight/checkpoints/Raw/Sony_Pixel/')
    parser.add_argument('--model_to_load2', type=str, default='1500')
    parser.add_argument('--checkpoint_dir', type=str, default='/workspace/midnight/checkpoints/Raw/Sony_Pixel/')

    parser.add_argument('--result_dir', type=str, default='/workspace/midnight/results/Raw/Sony_Pixel/')
    parser.add_argument('--val_result_dir', type=str, default='/workspace/midnight/result/Raw/Sony_Pixel/')
